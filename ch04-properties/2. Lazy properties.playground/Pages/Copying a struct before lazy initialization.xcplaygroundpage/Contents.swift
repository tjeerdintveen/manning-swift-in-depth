...
//: ## Copying a movie before lazy initialization
...
/*:
Notice how "The description is being set" is now called twice.
 
Also notice how each description is unique for each movie, as it should be.
*/

    print(homeAlone.description) // Home Alone released at Oct 16, 1990
    print(homeAloneTwo.description) // Home Alone 2 released at Oct 16, 1990
}
